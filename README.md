...
This is part 1 of our AirBnb Clone project. The purpose of this project is to make a commandinterpreter that manages our AirBnb objects
...
Example:
vagrant@vagrant-ubuntu-trusty-64:~$ ./console.py
(hbnb) help
